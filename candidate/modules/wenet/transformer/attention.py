# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# R057 wenet__transformer__attention —— 重建候选(candidate/modules/wenet/transformer/attention.py)
#
# 源件:modules/wenet/transformer/attention.cp310-win_amd64.pyd
#       sha256 = 55a1f739ce975820c6eb0e2c1c0bea2e9fb31b3f89a04dbbd0870bf7c3ae7e4d
# 对齐出处(二进制出处链):
#   [upstream] wenet-e2e/wenet @ 6480b8fffe372a170989fd65f9b9bd97ff368df3
#              旧布局 wenet/transformer/attention.py(该文件 blob sha256
#              c381eb148f431c91a47444f01d089fd03d10763f417cf79e2f8202114610783f;与 main 分支同名文件逐字节一致)
#   [pyd-strings] from wenet.utils.rope_utils import WENET_APPLY_ROTARY_EMB
#   [E1] 见 evidence/modules/wenet__transformer__attention/runtime/ 的 probe1/probe2b 输出
# 偏差登记:见 reports/modules/wenet__transformer__attention-impl.md §登记偏差
# ---------------------------------------------------------------------------
