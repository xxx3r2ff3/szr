# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# R060 wenet__transformer__encoder —— 重建候选(candidate/modules/wenet/transformer/encoder.py)
#
# 源件:modules/wenet/transformer/encoder.cp310-win_amd64.pyd
#       sha256 = 083e2abd6183b09df2f034ae2c3f38caeb0288992a20cba845fd9cc407bff5d7
# 对齐出处(二进制出处链):
#   [upstream] wenet-e2e/wenet @ 6480b8fffe372a170989fd65f9b9bd97ff368df3
#              旧布局 wenet/transformer/encoder.py(该文件 blob sha256
#              72e97c7d064e3941bec92740bfeda9cbcfe3f47a9a99f2076bf8b968dc67d232;与 main 分支同名文件逐字节一致;本模块额外裁剪 TransformerEncoder)
#   [pyd-strings] from wenet.transformer.convolution import ConvolutionModule / from wenet.transformer.encoder_layer import ConformerEncoderLayer / from wenet.utils.{class_utils,common,mask}
#   [E1] 见 evidence/modules/wenet__transformer__encoder/runtime/ 的 probe1/probe2b 输出
# 偏差登记:见 reports/modules/wenet__transformer__encoder-impl.md §登记偏差
# ---------------------------------------------------------------------------
