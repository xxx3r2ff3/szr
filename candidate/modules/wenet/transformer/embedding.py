# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# R059 wenet__transformer__embedding —— 重建候选(candidate/modules/wenet/transformer/embedding.py)
#
# 源件:modules/wenet/transformer/embedding.cp310-win_amd64.pyd
#       sha256 = b5aa675e1e29d0632d5fdb360041cdcf540f8d2ec818c5b324b1a93344e96787
# 对齐出处(二进制出处链):
#   [upstream] wenet-e2e/wenet @ 6480b8fffe372a170989fd65f9b9bd97ff368df3
#              旧布局 wenet/transformer/embedding.py(该文件 blob sha256
#              f5de27312b56ebf170dc07a88d79b814dca4de340d21118ac6be88745c88971c;与 main 分支同名文件逐字节一致)
#   [pyd-strings] from wenet.utils.rope_utils import precompute_freqs_cis
#   [E1] 见 evidence/modules/wenet__transformer__embedding/runtime/ 的 probe1/probe2b 输出
# 偏差登记:见 reports/modules/wenet__transformer__embedding-impl.md §登记偏差
# ---------------------------------------------------------------------------
