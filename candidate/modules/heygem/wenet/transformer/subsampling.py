# -*- coding: utf-8 -*-
# 出处:S003 恢复件(candidate/modules/heygem/wenet/transformer/subsampling.pyc,py3.8)。
# 反汇编:evidence/modules/_heygem_orphans/disasm/wenet_transformer_subsampling.pyc.dis
# 字节码全局名对照:AssertionError <- assert 语句隐式加载(py3.8)。
