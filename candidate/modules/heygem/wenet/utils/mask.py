# -*- coding: utf-8 -*-
# 出处:S003 恢复件(candidate/modules/heygem/wenet/utils/mask.pyc,py3.8)。
# 反汇编:evidence/modules/_heygem_orphans/disasm/wenet_utils_mask.pyc.dis
# 说明:.dis 模块 [Constants][0] 为 0,原模块无 docstring,出处写在此注释块。
# 字节码全局名对照:AssertionError <- assert 语句隐式加载;float <- -float('inf')。
import torch
